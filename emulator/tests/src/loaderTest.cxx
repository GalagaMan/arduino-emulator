...
SCENARIO("HexProgramLoader correctly loads Intel HEX data into FlashMemory via MemoryController")
{
    GIVEN("a MemoryController with registered FlashMemory")
    {
        ...
        {
            const std::string hexContent = ":100000000C9434000C9451000C9451000C94510049\n"
            ...
            THEN("FlashMemory contains expected data at various offsets")
            {
                ...
                checkBytes(0x0000, {0x0C, 0x94, 0x34, 0x00, 0x0C, 0x94, 0x51, 0x00, 0x0C, 0x94, 0x51, 0x00, 0x0C, 0x94,
                                    0x51, 0x00});

                checkBytes(0x0060, {0x0C, 0x94, 0x51, 0x00, 0x0C, 0x94, 0x51, 0x00, 0x11, 0x24, 0x1F, 0xBE, 0xCF, 0xEF,
                                    0xD8, 0xE0});

                checkBytes(0x01CE, {0x31, 0x61, 0x62, 0x63, 0x64, 0x65, 0x66, 0x67, 0x31, 0x00});
            }
        }
